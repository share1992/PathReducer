...
traj_lengths, system_name, direc, coords_pca, coords_pca_fit, coords_comps, coords_mean, coords_vals, full, red = \
    dim_red.dr_routine(file, ndim, atom_1, atom_2, atom_3, atom_4, input_type="Coordinates")
...
# # Transforming new data into generated reduced dimensional space
# dim_red.transform_new_data(new_file, direc + "/new_data", ndim, atom_1, atom_2, atom_3, atom_4, coords_pca_fit,
# coords_comps, coords_mean, coords_pca, input_type="Coordinates")
...
#
# # Transforming new data into generated reduced dimensional space
# dim_red.transform_new_data(new_file, direc1 + "/new_data", ndim, atom_1, atom_2, atom_3, atom_4, D_pca_fit,
